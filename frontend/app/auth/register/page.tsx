    ...
    <AuthCard>
      ...
      >
        <motion.div variants={itemVariants} className="space-y-2">
          <AuthHeading>Start your adventure! 🚀</AuthHeading>
          <AuthSubheading>
            Create your account and begin learning Yoruba today.
          </AuthSubheading>
        </motion.div>
            ...
            {[1, 2, 3, 4].map((index) => (
              <div
                ...
                className={`h-2 flex-1 rounded-full transition-colors ${
                  index <= strength ? STRENGTH_COLORS[strength] : "bg-black/10"
                }`}
              />
            ))}
            <span
              className="text-xs font-semibold text-[#5A4A2A]"
              style={{
