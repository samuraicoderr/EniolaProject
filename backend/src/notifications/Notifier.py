...
class NotifyUser:
    ...
    @staticmethod
    def send_doctor_invitation(recipient_email: str, hospital_name: str, invitation_link: str, thread=True) -> None:
        context = {
            "hospital_name": hospital_name,
            "invitation_link": invitation_link,
        }
        Notifier._send_email(
            template_name='notifications/emails/hospitals/doctor_invitation.html',
            subject=f'Invitation to join {hospital_name}',
            recipient_emails=[recipient_email.lower()],
            context=context,
            thread=thread,
        )
